...
# of which 2709 customers did not accept the loan and 291 customers 
...
# Of the eight terminal nodes, four lead to classification of “did not accept”
# and four lead to classification of “accept.” 
...
deeper.ct <- rpart(Personal.Loan ~ ., data = train.df, method = "class", cp = 0.009, minsplit = 1)
...
#    redesignating it as a terminal node.
